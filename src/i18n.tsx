...
export function LanguageProvider({ children }: { children: ReactNode }) {
  const [language, setState] = useState<Language>(() => {
    const v =
      ...
      localStorage.getItem("redflags.language");
    return v === "fr" || v === "en"
      ? v
